            ...
            <ul class="perfect-scrollbar relative h-[calc(100vh-80px)] space-y-0.5 overflow-y-auto overflow-x-hidden p-4 py-0 font-semibold"
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'hotels'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="{{ route('admin.hero-slides.index') }}">Hero Sliders</a>
                        </li>
                        <li>
                            <a href="{{ route('admin.about.edit') }}">About Content & Story</a>
                        </li>
                        <li>
                            <a href="{{ route('admin.dining.index') }}">Dining & Restaurants</a>
                        </li>
                        <li>
                            <a href="{{ route('admin.facilities.index') }}">Hotel Facilities & Spa</a>
                        </li>
                        <li>
                            <a href="{{ route('admin.gallery.index') }}">Hotel Gallery Photos</a>
                        </li>
                        <li>
                            <a href="{{ route('admin.hotels.index') }}">Manage Hotels</a>
                        </li>
                        <li>
                            <a href="{{ route('admin.room-types.all') }}">Room Types & Photos</a>
                        </li>
                        <li>
                            <a href="{{ route('admin.hotels.create') }}">Add Hotel</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'bookings'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="{{ route('admin.bookings.hotel.index') }}">Hotel Bookings</a>
                        </li>
                        <li>
                            <a href="{{ route('admin.bookings.hotel.temporary') }}">Temporary Requests</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'communications'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="{{ route('admin.inquiries.index') }}">Guest Inquiries</a>
                        </li>
                        <li>
                            <a href="{{ route('admin.newsletter.index') }}">Newsletter Subscribers</a>
                        </li>
                    </ul>
                </li>
